...
namespace FitBites.Application.DTOs.Ingredient
{
    ...
    public class CreateIngredientDto
    {
        ...
        /// 营养成分集合
        /// </summary>
        public List<CreateIngredientNutritionDto> Nutritions { get; set; } = new List<CreateIngredientNutritionDto>();

        /// <summary>
        /// 人群适宜/忌用映射集合
        /// </summary>
        public List<CreateIngredientHumanGroupDto> HumanGroups { get; set; } = new List<CreateIngredientHumanGroupDto>();

        /// <summary>
        /// 预处理集合
        /// </summary>
        public List<CreateIngredientPreprocessDto> Preprocesses { get; set; } = new List<CreateIngredientPreprocessDto>();
    }
    ...
    /// 创建食材人群适宜/忌用映射数据传输对象
    /// </summary>
    public class CreateIngredientHumanGroupDto
    {
        /// <summary>
        /// 人群标签ID
        /// </summary>
    ...
    /// 创建食材预处理方法数据传输对象
    /// </summary>
    public class CreateIngredientPreprocessDto
    {
        /// <summary>
        /// 加工方式（如捣碎、焯水、冷藏、挂浆等）
        /// </summary>
